...
export const USERS: AdminUserDTO[] = [
  { id: "usr_eren", username: "eren", displayName: "Eren Yılmaz", email: null, onboardingCompleted: true, role: "admin", gender: "male", heightCm: 183, birthDate: "1996-04-18", activityLevel: "moderate", measurementDay: 0, mascotEnabled: true, createdAt: "2025-11-02T07:12:00.000Z", lastSeenAt: new Date(Date.now() - 12 * 60 * 1000).toISOString(), hasProgram: true, goalStatus: "active" },
  { id: "usr_inci", username: "inci", displayName: "İnci Demir", email: null, onboardingCompleted: true, role: "user", gender: "female", heightCm: 166, birthDate: "1998-11-05", activityLevel: "light", measurementDay: 1, mascotEnabled: true, createdAt: "2025-11-02T07:14:00.000Z", lastSeenAt: new Date(Date.now() - 3 * 3600 * 1000).toISOString(), hasProgram: true, goalStatus: "active" },
  { id: "usr_kaan", username: "kaan", displayName: "Kaan Aksoy", email: null, onboardingCompleted: true, role: "user", gender: "male", heightCm: 178, birthDate: "1993-02-22", activityLevel: "active", measurementDay: 0, mascotEnabled: true, createdAt: "2026-01-19T09:41:00.000Z", lastSeenAt: new Date(Date.now() - 26 * 3600 * 1000).toISOString(), hasProgram: true, goalStatus: "completed" },
  { id: "usr_selin", username: "selin", displayName: "Selin Korkmaz", email: null, onboardingCompleted: true, role: "user", gender: "female", heightCm: 171, birthDate: "2000-07-30", activityLevel: "moderate", measurementDay: 3, mascotEnabled: false, createdAt: "2026-03-08T16:02:00.000Z", lastSeenAt: new Date(Date.now() - 5 * 86400 * 1000).toISOString(), hasProgram: false, goalStatus: null },
  { id: "usr_mert", username: "mert", displayName: "Mert Şahin", email: null, onboardingCompleted: true, role: "user", gender: "male", heightCm: 175, birthDate: "1989-09-12", activityLevel: "sedentary", measurementDay: 0, mascotEnabled: true, createdAt: "2026-05-27T12:55:00.000Z", lastSeenAt: new Date(Date.now() - 19 * 86400 * 1000).toISOString(), hasProgram: true, goalStatus: "abandoned" },
  { id: "usr_zeynep", username: "zeynep", displayName: "Zeynep Arslan", email: null, onboardingCompleted: true, role: "user", gender: "female", heightCm: 160, birthDate: "1995-12-01", activityLevel: "veryActive", measurementDay: 6, mascotEnabled: true, createdAt: "2026-08-04T10:10:00.000Z", lastSeenAt: new Date(Date.now() - 90 * 60 * 1000).toISOString(), hasProgram: true, goalStatus: "active" },
];
