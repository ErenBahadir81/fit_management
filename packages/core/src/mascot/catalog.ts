...
export const DEFAULT_MASCOT_MESSAGES: MascotTemplate[] = [
  ...
  { key: "home.streak", mood: "hype", variants: ["{streak} gün üst üste. Bu ivmeyi seviyorum.", "Seri sürüyor: {streak} gün. Bugünü de ekleyelim mi?", "{streak} günlük seri — momentum senden yana."] },
  ...
  { key: "report.missedWeek", mood: "sad", variants: ["Bu hafta pek görüşemedik. Olur böyle şeyler, yeni hafta yeni sayfa.", "Sessiz bir hafta oldu. Tek bir kayıt bile beni geri getirir.", "Bu hafta veri yok. Seni yargılamıyorum, sadece merak ettim."] },
  ...
  { key: "goal.milestone", mood: "proud", variants: ["Bir kilometre taşı geride: {kg} kg gitti.", "Ara hedefe ulaştın. Sakin ve istikrarlı, tam istediğim gibi.", "Buraya kadar gelmek kolay değildi. {weeks} hafta kaldı."] },
  { key: "goal.abandoned", mood: "sad", variants: ["Hedefi kapattık. Hazır olduğunda yenisini birlikte kurarız.", "Şimdilik ara veriyoruz; ben buradayım.", "Hedef rafta duruyor. Dönmek istediğinde tek dokunuş yeter."] },
  ...
  { key: "scan.newFood", mood: "curious", variants: ["Bunu ilk kez görüyorum. Adını sen koy, ben öğreneyim.", "İlginç bir tabak. Ne olduğunu söylersen kaydederim.", "Yeni bir şey mi bu? Merak ettim."] },
  ...
  { key: "body.newLow", mood: "proud", variants: ["Trend en düşük noktasında: {kg} kg. Emeğin görünüyor.", "Yeni bir dip. Terazi değil, trend konuşuyor.", "Bugüne kadarki en düşük trend ağırlığı. Güzel gidiyor."] },
  ...
  { key: "workout.lastSet", mood: "hype", variants: ["Son set. Buraya kadar geldiysen bunu da yaparsın.", "Kalan tek set — nefes al ve dal.", "Bitişe bir set kaldı. Hepsini burada bırak."] },
  ...
  { key: "recovery.unbalanced", mood: "curious", variants: ["{muscle} epeydir sırada değil. Bu hafta ona da yer açalım mı?", "Bir bölge geride kalmış gibi: {muscle}. Bakalım mı?", "{muscle} uzun süredir dinleniyor. Plan mı, denk mi geldi?"] },
];

/**
 * How each mood reads in Turkish — the accessibility label a screen reader announces for Floo's
 * face. Kept here so the app and the admin panel cannot drift apart on what "hype" means.
 */
